...
def scrape_flipkart_data(url):
    ...
    flipkart_df.to_csv("static/flipkart_data.csv", index=False)  # Save CSV in the static folder
    return "flipkart_data.csv"  # Return the filename
...
def index():
    if request.method == 'POST':
        ...
        return redirect(url_for('static', filename=csv_filename))  # Redirect to the CSV file
